"""
Web Project Folder Structure Creator

Creates standardized folder structure for web/development projects.
...
class FolderStructureCreator(FormKeyboardMixin):
    ...
    def __init__(self, root_or_frame, embedded=False, on_project_created=None, on_cancel=None, project_db=None):
        ...
        if embedded:
            ...
            self.parent = root_or_frame
            self.root.title("Web Folder Structure")
    ...
    def _build_form(self):
        ...
        if self.project_db:
            self.client_entry = AutocompleteEntry(
                row1, db=self.project_db, category="Web",
        ...
        self.tree_file = os.path.join(TEMPLATES_DIR, 'web_structure.txt')
