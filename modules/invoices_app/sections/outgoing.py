...
from global_invoice.filer import file_pdf, quarter_dir_for, quarter_for
from global_invoice.models import format_money
...
from invoices_app.widgets.inputs import make_entry
from invoices_app.widgets.tree import make_treeview

logger = get_logger("invoices_app.outgoing")
...
class OutgoingSection(Section):
    ...
    def _insert_legacy_row(self, parent_id: str, r: Any) -> None:
        ...
        if r.notes:
            desc = f"⚠ {desc}"
        from global_invoice.legacy_scanner import PATTERN_UNRECOGNISED
